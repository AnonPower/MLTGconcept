...
public class EffectOutResponse {
	...
	////////////////////////////////////////////////////////////////
	//////These functions may be used in other things as well.//////
	////////////////////////////////////////////////////////////////
	/*
	 *	EXPLODE
	 *	Puts a string into arrays. Name inspiration from PHP
	 *		@param	String	str				Input string
	 *		@param	String	exception	Input exception
	 *
	 *		@return	String[]	split		The String splitted into an array
	 */
	...
	/*
	 *	IMPLODE
	 *	Puts the array back into a string. Name inspiration from PHP
	 *		@param	String[]	arr				Input array
	 *		@param	String		exception	Exception from stored gobal var by explode()
	 *
	 *		@return String		The array put together with the exception
	 */
	public static String implode(String[] arr,String exception){
		...
		for(int i=0;i<arr.length;++i){
			appendedString += arr[i] + exception;
		}
