...
public class XMLDataGrabber {
	...
	public String grabCommand(ArrayList<String> commandList,
			ArrayList<String> selectedCommandsList, String input, String doer,
			int d) {
		int ranNum;
	...
	public String grabTarChar(ArrayList<String> characterList,
			ArrayList<String> tarCharacterList, String input, int chanceMod,
			String doer) {
		int ranNum;
	...
	public String grabObj(ArrayList<String> objList,
			ArrayList<String> objsUsedList, String input, int chanceMod) {
		int ranNum;
	...
	public String grabToTar(ArrayList<String> toTarLinkingList,
			ArrayList<String> toTarLinkingsUsedList, String input, int chanceMod) {
		int ranNum;
	...
	public String grabUse(ArrayList<String> useLinkingList,
			ArrayList<String> useLinkingsUsedList, String input, int chanceMod) {
		int ranNum;
